...
$secrets = @{
    ...
    "ZEPTOMAIL_API_KEY" = "Zoho-enczapikey wSsVR61y+xH0Ca54mTyoJuxpkFpdUwunRB543Fvy7HCoSqvG9sc7kkeaAwauG/UbEGRsHTAW9bx6yk0H2jcP3dh/nAxTACiF9mqRe1U4J3x17qnvhDzDXGtekxCOLIkLxgtvm2NoG84h+g=="
    "ZEPTOMAIL_FROM_EMAIL" = "noreply@favoredfamilyyaya.org"
